...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => {
  ...
  return (
    <div className="min-w-190 minlg:min-w-240 hover:opacity-80 hover:scale-105 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3 border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4">
